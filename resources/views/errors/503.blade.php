...
<head>
    ...
    <title>Mantenimiento — {{ config('app.name', 'Taller Pro') }}</title>
    ...
    <style>
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .error-code { font-size:5rem; font-weight:800; color:#3498db; line-height:1; margin-bottom:.5rem; }
...
<body>
    <div class="error-wrap">
        ...
        <p class="error-text">Estamos realizando mejoras para brindarte un mejor servicio.<br>Vuelve a intentarlo en unos momentos.</p>
