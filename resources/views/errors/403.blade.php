...
<head>
    ...
    <title>Acceso denegado — {{ config('app.name', 'Taller Pro') }}</title>
...
<body>
    <div class="error-wrap">
        ...
        <p class="error-text">No tienes permiso para acceder a esta página.<br>Si crees que esto es un error, contacta al administrador del sistema.</p>
