...
<head>
    ...
    <title>Sesión expirada — {{ config('app.name', 'Taller Pro') }}</title>
    ...
    <style>
        * { margin:0; padding:0; box-sizing:border-box; }
        ...
        .error-code { font-size:5rem; font-weight:800; color:#8e44ad; line-height:1; margin-bottom:.5rem; }
...
<body>
    <div class="error-wrap">
        ...
        <p class="error-text">Tu sesión ha expirado por inactividad.<br>Inicia sesión nuevamente para continuar.</p>
        <a href="{{ route('login') }}" class="btn-home">Ir al inicio de sesión</a>
    </div>
</body>
</html>
