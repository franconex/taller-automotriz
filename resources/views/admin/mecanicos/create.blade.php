...
@section('navbar-title', 'Nuevo mecánico')
...
@section('content')
    <x-admin.page-header
        ...
        description="Asigna un empleado como mecánico del taller.">
        <x-slot:actions>
    ...
    <div class="admin-table-wrap p-4">
        <form method="POST" action="{{ route('admin.mecanicos.store') }}">
            @csrf
            @include('admin.mecanicos._form', ['mecanico' => null])
