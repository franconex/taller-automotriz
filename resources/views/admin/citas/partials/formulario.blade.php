            ...
            <form id="formulario-cita" novalidate>
                ...
                <div class="modal-body">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            <div class="citas-form-section">
                                <h3 class="citas-form-section__title">Cliente y vehículo</h3>
                                <div class="row g-2">
                                    <div class="col-md-6">
                        ...
                        <div class="col-12">
                            <div class="citas-form-section">
                                <h3 class="citas-form-section__title">Programación</h3>
                                <div class="row g-2">
                                    <div class="col-md-4">
                        ...
                        <div class="col-12">
                            <div class="citas-form-section">
                                <h3 class="citas-form-section__title">Asignación</h3>
                                <div class="row g-2">
                                    <div class="col-md-6">
                                    ...
                                    <div class="col-md-6">
                                        <label class="form-label" for="form-mecanico_id">Mecánico (opcional)</label>
                        ...
                        <div class="col-12">
                            <div class="citas-form-section">
                                <h3 class="citas-form-section__title">Detalle</h3>
                                <div class="row g-2">
                                    <div class="col-12">
                                        <label class="form-label" for="form-descripcion_problema">Descripción del problema <span class="required">*</span></label>
                                        <textarea name="descripcion_problema" id="form-descripcion_problema" class="form-control" rows="3" required></textarea>
                                        <div class="invalid-feedback"></div>
                                    </div>
                                    <div class="col-md-6">
                                        <label class="form-label" for="form-costo_consulta">Costo de consulta</label>
                        ...
                        <div class="col-12">
                            <div class="citas-form-section">
                                <h3 class="citas-form-section__title">Estado inicial</h3>
                                <div class="row g-2">
                                    <div class="col-md-4">
